        ...
        const interval = setInterval(() => {
            if (!state.deliverNow) {
                modals.openContextModal({
                    modal: "agree",
                    title: "Selección hora programada",
                    innerProps: {
                        modalBody: "La franja de horas disponible para entrega ha sido actualizada debido a ausencia de actividad en los últimos 5 minutos."
                    }
                });
            }
        }, 300000); // 5 min
